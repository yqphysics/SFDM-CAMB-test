...
subroutine ode45(fin,neqn,t_start,t_stop,n_step,y0,tval,yval,option, parmas )
  use iso_c_binding
  implicit none
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !!!  输入量  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !
    ...
    call f ( neqn, t + 3.0D+00 * h / 8.0D+00, f5, f2, parmas )
    ...
    call f ( neqn, t + 12.0D+00 * h / 13.0D+00, f5, f3, parmas )
    ...
    call f ( neqn, t + h / 2.0D+00, f1, f5 , parmas )
  !
  ...
  !
    ...
    integer :: neqn
    real(dl) :: abserr
    real(dl), save :: abserr_save = -1.0D+00
    real(dl) :: ae
    real(dl) :: dt
    real(dl) :: ee
    real(dl) :: eeoet
    ...
    real(dl) :: relerr
    real(dl) :: relerr_min
    real(dl), save :: relerr_save = -1.0D+00
